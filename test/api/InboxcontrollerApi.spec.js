...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Emaile2eApiDocumentation.InboxcontrollerApi();
  });
  ...
  describe('InboxcontrollerApi', function() {
    ...
    describe('indexUsingGET', function() {
      it('should call indexUsingGET successfully', function(done) {
        //uncomment below and update the code to test indexUsingGET
        //instance.indexUsingGET(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('viewUsingGET', function() {
      it('should call viewUsingGET successfully', function(done) {
        //uncomment below and update the code to test viewUsingGET
        //instance.viewUsingGET(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
