...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Emaile2eApiDocumentation.ResponseListInboxDto();
  });
  ...
  describe('ResponseListInboxDto', function() {
    it('should create an instance of ResponseListInboxDto', function() {
      // uncomment below and update the code to test ResponseListInboxDto
      //var instane = new Emaile2eApiDocumentation.ResponseListInboxDto();
      //expect(instance).to.be.a(Emaile2eApiDocumentation.ResponseListInboxDto);
    });
