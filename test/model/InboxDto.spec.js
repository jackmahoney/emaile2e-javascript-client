...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Emaile2eApiDocumentation.InboxDto();
  });
  ...
  describe('InboxDto', function() {
    it('should create an instance of InboxDto', function() {
      // uncomment below and update the code to test InboxDto
      //var instane = new Emaile2eApiDocumentation.InboxDto();
      //expect(instance).to.be.a(Emaile2eApiDocumentation.InboxDto);
    });
