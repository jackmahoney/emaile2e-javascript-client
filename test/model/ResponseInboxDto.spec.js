...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Emaile2eApiDocumentation.ResponseInboxDto();
  });
  ...
  describe('ResponseInboxDto', function() {
    it('should create an instance of ResponseInboxDto', function() {
      // uncomment below and update the code to test ResponseInboxDto
      //var instane = new Emaile2eApiDocumentation.ResponseInboxDto();
      //expect(instance).to.be.a(Emaile2eApiDocumentation.ResponseInboxDto);
    });
