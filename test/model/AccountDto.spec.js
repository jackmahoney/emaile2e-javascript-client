...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailslurpClient.AccountDto();
  });
  ...
  describe('AccountDto', function() {
    it('should create an instance of AccountDto', function() {
      ...
      //var instane = new MailslurpClient.AccountDto();
      //expect(instance).to.be.a(MailslurpClient.AccountDto);
    });
    ...
    it('should have the property priceCents (base name: "priceCents")', function() {
      // uncomment below and update the code to test the property priceCents
      //var instane = new MailslurpClient.AccountDto();
      //expect(instance).to.be();
    });

    it('should have the property priceString (base name: "priceString")', function() {
      // uncomment below and update the code to test the property priceString
      //var instane = new MailslurpClient.AccountDto();
      //expect(instance).to.be();
    });

    it('should have the property stripeProduct (base name: "stripeProduct")', function() {
      // uncomment below and update the code to test the property stripeProduct
      //var instane = new MailslurpClient.AccountDto();
      //expect(instance).to.be();
    });
