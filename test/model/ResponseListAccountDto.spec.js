...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailslurpClient.ResponseListAccountDto();
  });
  ...
  describe('ResponseListAccountDto', function() {
    it('should create an instance of ResponseListAccountDto', function() {
      // uncomment below and update the code to test ResponseListAccountDto
      //var instane = new MailslurpClient.ResponseListAccountDto();
      //expect(instance).to.be.a(MailslurpClient.ResponseListAccountDto);
    });
