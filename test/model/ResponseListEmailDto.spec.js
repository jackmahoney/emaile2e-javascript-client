...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Emaile2eApiDocumentation.ResponseListEmailDto();
  });
  ...
  describe('ResponseListEmailDto', function() {
    it('should create an instance of ResponseListEmailDto', function() {
      // uncomment below and update the code to test ResponseListEmailDto
      //var instane = new Emaile2eApiDocumentation.ResponseListEmailDto();
      //expect(instance).to.be.a(Emaile2eApiDocumentation.ResponseListEmailDto);
    });
