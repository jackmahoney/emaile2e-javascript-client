...
import InboxDto from './model/InboxDto';
...
import InboxControllerApi from './api/InboxControllerApi';
import UserControllerApi from './api/UserControllerApi';


/**
* JS client for MailSlurp email testing API.<br>
* The <code>index</code> module provides access to constructors for all the classes which comprise the public API.
* <p>
* An AMD (recommended!) or CommonJS application will generally do something equivalent to the following:
* <pre>
* var MailslurpApiClient = require('index'); // See note below*.
* var xxxSvc = new MailslurpApiClient.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new MailslurpApiClient.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new MailslurpApiClient.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new MailslurpApiClient.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
