...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MailSlurpApiDocumentation.InboxControllerApi = factory(root.MailSlurpApiDocumentation.ApiClient, root.MailSlurpApiDocumentation.Response, root.MailSlurpApiDocumentation.ResponseInboxDto, root.MailSlurpApiDocumentation.ResponseListEmailDto, root.MailSlurpApiDocumentation.ResponseListInboxDto, root.MailSlurpApiDocumentation.SendEmailDto);
  }
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the createRandomInboxUsingPOST operation.
     * @callback module:api/InboxControllerApi~createRandomInboxUsingPOSTCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ResponseInboxDto} data The data returned by the service call.
     ...
     * @param {module:api/InboxControllerApi~createRandomInboxUsingPOSTCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ResponseInboxDto}
     */
    this.createRandomInboxUsingPOST = function(apiKey, callback) {
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the deleteInboxUsingDELETE operation.
     * @callback module:api/InboxControllerApi~deleteInboxUsingDELETECallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/InboxControllerApi~deleteInboxUsingDELETECallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Response}
     */
    this.deleteInboxUsingDELETE = function(apiKey, uuid, callback) {
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the getEmailsForInboxUsingGET operation.
     * @callback module:api/InboxControllerApi~getEmailsForInboxUsingGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ResponseListEmailDto} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/InboxControllerApi~getEmailsForInboxUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ResponseListEmailDto}
     */
    this.getEmailsForInboxUsingGET = function(apiKey, uuid, opts, callback) {
      opts = opts || {};
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the getListOfInboxesUsingGET operation.
     * @callback module:api/InboxControllerApi~getListOfInboxesUsingGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ResponseListInboxDto} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} apiKey Your API Key. Sign up and find it in your dashboard.
     * @param {module:api/InboxControllerApi~getListOfInboxesUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ResponseListInboxDto}
     */
    this.getListOfInboxesUsingGET = function(apiKey, callback) {
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the sendEmailFromUserUsingPOST operation.
     * @callback module:api/InboxControllerApi~sendEmailFromUserUsingPOSTCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/InboxControllerApi~sendEmailFromUserUsingPOSTCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Response}
     */
    this.sendEmailFromUserUsingPOST = function(apiKey, uuid, sendEmailDto, callback) {
