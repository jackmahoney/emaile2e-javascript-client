...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AccountDto'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AccountDto'));
  } else {
    // Browser globals (root is window)
    if (!root.MailslurpClient) {
      root.MailslurpClient = {};
    }
    root.MailslurpClient.ResponseListAccountDto = factory(root.MailslurpClient.ApiClient, root.MailslurpClient.AccountDto);
  }
}(this, function(ApiClient, AccountDto) {
  'use strict';
   ...
   * @version 0.1.1535640583
   */

  /**
   * Constructs a new <code>ResponseListAccountDto</code>.
   * @alias module:model/ResponseListAccountDto
   * @class
   */
  ...
  /**
   * Constructs a <code>ResponseListAccountDto</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResponseListAccountDto} obj Optional instance to populate.
   * @return {module:model/ResponseListAccountDto} The populated <code>ResponseListAccountDto</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('payload')) {
        obj['payload'] = ApiClient.convertToType(data['payload'], [AccountDto]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/AccountDto>} payload
   */
