...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MailSlurpApiDocumentation.UserDto = factory(root.MailSlurpApiDocumentation.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('newUser')) {
        obj['newUser'] = ApiClient.convertToType(data['newUser'], 'Boolean');
      }
  ...
  /**
   * @member {module:model/UserDto.AccountTypeEnum} accountType
   */
